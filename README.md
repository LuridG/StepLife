...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-v1.4.14-emerald" alt="Version" />
...
| :--- | :--- | :---: | :--- |
| **`StepLife-v1.4.14-arm64-v8a.apk`** | 64 位 ARM (`arm64-v8a`) | **26.9 MB** | 🔥 **最推荐**！适配 99% 的现代 Android 手机 |
| **`StepLife-v1.4.14-armeabi-v7a.apk`** | 32 位 ARM (`armeabi-v7a`) | 24.7 MB | 适配老旧 32 位 Android 机型 |
| **`StepLife-v1.4.14-x86_64.apk`** | Intel/AMD (`x86_64`) | 28.3 MB | 适配 Android 模拟器与 x86 平板 |
| **`StepLife-v1.4.14-universal.apk`** | 通用全架构胖包 | 66.0 MB | 整合全架构二进制，兼容任意设备 |
...
git add -A && git commit -m "chore: release v1.4.14"
git tag v1.4.14+20260816
